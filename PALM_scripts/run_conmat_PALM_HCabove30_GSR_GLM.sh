...
#SBATCH --output=/projects/ttan/ASDD/Data/PALM/logs/PALM_HCabove30_noGSR_GLM%j.txt
#SBATCH --error=/projects/ttan/ASDD/Data/PALM/logs/PALM_HCabove30_noGSR_GLM%jerr.txt
#SBATCH --array=1-3
...
DIR="/projects/ttan/ASDD/Data/PALM"

sublistids="${DIR}/subid_GSR/HCabove30_sublist_GSR.txt"
filename="$(find $DIR/filelists/HCabove30/GLM/filelist* -type f | head -n $SLURM_ARRAY_TASK_ID | tail -n 1)"
truncname="$(echo $(basename `echo "$filename"`) | sed 's/filelist/HCabove30_GSR_GLM_con/;s/.txt//')"
